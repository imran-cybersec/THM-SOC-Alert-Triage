...
* **Severity:** High
* **Host System:** `LPT-HR-009` (HR Department)
* **User:** `S.Conway`
* **Trigger Event:** User downloaded a file named `cats2025.mp4.exe` from an external domain (`https://freecatvideoshd.monster`).
* **Investigation:** * Extracted the unique MD5 file hash: `14d8486f3f63875ef93cfd240c5dc10b`.
...
* **Severity:** Low
* **Host/Network:** `LPT-IT-063` (VPN/DEVELOPERS)
* **User:** `G.Chandler`
